...
export const GLYPH = {
  ...
  students:
    "M9 7a3 3 0 106 0 3 3 0 00-6 0M4 20a5 5 0 0110 0M15 12a3 3 0 100-6M17 20a5 5 0 00-3-4.6",
...
export const CHILD = {
  name: "Aarav Mehta",
  klass: "Grade 5 · Section B",
  klassShort: "Grade 5-B",
  roll: 14,
};
export const SCHOOL = "My School Space";
...
export const NOTICES: Notice[] = [
  {
    id: "ptm",
    category: "Principal",
    from: "Ms. Sridevi Menon · Principal",
    pinned: true,
    date: "24 Jun",
    icon: GLYPH.notices,
  ...
  },
  {
    ...
    title: "Half-day this Friday, 27 June",
  ...
  },
  {
    ...
    pinned: false,
    date: "20 Jun",
    icon: "M6 4h12v3a6 6 0 01-12 0zM10 13h4v3h-4z",
    title: "Annual Sports Day — kit list",
  ...
  },
  {
    ...
    pinned: false,
    date: "18 Jun",
    icon: "M4 16V7a2 2 0 012-2h12a2 2 0 012 2v9M4 16h16M7 16v2M17 16v2M6 11h12",
    title: "Revised bus timings from 1 July",
...
export const CAL_EVENTS: CalEvent[] = [
  {
    ...
    d: "28",
    title: "Parent–Teacher Meeting",
    sub: "9:00 AM – 1:00 PM · Main block",
    accent: "#c2a04e",
  },
  {
    m: "JUL",
    ...
    sub: "Full day · Sports ground",
    accent: "#15412f",
  },
  {
    m: "JUL",
    d: "09",
    title: "Unit Test 3 begins",
...
export const NOTIFS = [
  {
    ...
    sub: "Marked 8:42 AM by Ms. Rao",
    tm: "now",
  },
  {
    path: "M3 6h18v14H3zM3 13l5-4 4 3 5-5 4 4",
    title: "New album: Annual Sports Day",
    sub: "142 photos from this morning",
    tm: "1h",
  },
  {
    path: GLYPH.diary,
    title: "Homework posted for Wed",
    sub: "3 subjects · Maths, Science, English",
    tm: "3h",
  },
  {
    path: GLYPH.notices,
    title: "Notice: Parent–Teacher Meeting",
    sub: "From the Principal · please acknowledge",
    tm: "1d",
  },
  {
    path: "M6 3h9l4 4v14H6z",
    title: "Unit Test 2 results published",
    sub: "Aarav scored 88% · class rank 3",
    tm: "2d",
  },
];
...
export const DIARY_BY_DATE: Record<string, DiaryDay> = {
  "16": {
    ...
    tasks: [
      {
        subj: "Mathematics",
        note: "Ms. Rao · Worksheet 9, place value",
        done: true,
      },
  ...
  "17": {
    ...
    tasks: [
      {
        subj: "Science",
        note: "Mr. Nair · label the parts of a plant",
        done: true,
      },
  ...
  "18": {
    ...
    tasks: [
      ...
      {
        subj: "Computer",
        note: "Mr. Das · draw a simple flowchart",
        done: true,
      },
    ],
  },
  "19": {
    ...
    tasks: [
      {
        subj: "English",
        note: "Ms. Kapoor · read chapter 5 aloud",
        done: true,
      },
  ...
  "20": {
    note: "Bring your art file on Monday. — Ms. Bose",
    tasks: [
      { subj: "Mathematics", note: "Ms. Rao · revision sheet", done: true },
      {
        subj: "Art",
        note: "Ms. Bose · finish the landscape sketch",
        done: true,
      },
    ],
  },
  "23": {
    ...
    tasks: [
      {
        subj: "Mathematics",
        note: "Ms. Rao · Worksheet 11, fractions",
        done: true,
      },
  ...
  "24": {
    note: "PT kit needed tomorrow. — Coach Singh",
    tasks: [
      {
        subj: "Mathematics",
        note: "Ms. Rao · Worksheet 11 (part B)",
        done: true,
      },
  ...
  "25": {
    note: "Please send a fresh leaf for tomorrow's Science lab. — Mr. Nair",
    tasks: [
      {
        subj: "Mathematics",
        note: "Ms. Rao · Worksheet 12, fractions",
        done: true,
      },
      {
        subj: "Science",
        note: "Mr. Nair · read pp. 40–44, leaf diagram",
        done: false,
      },
      {
        subj: "English",
        note: 'Ms. Kapoor · paragraph on "My favourite season"',
        done: false,
      },
    ],
  },
...
export function attCells() {
  ...
  for (let d = 1; d <= 30; d++) {
    let color = "#1f8a5b",
      future = false;
    if (sun.includes(d) || sat.includes(d) || holiday.includes(d))
      color = "#e6e9e3";
    if (absent.includes(d)) color = "#c0392b";
    if (d > 25 && !sun.includes(d) && !sat.includes(d)) {
      color = "#f1f5f1";
      future = true;
    }
    out.push({
      ...
      color,
      showDot: !future,
      txt: color === "#e6e9e3" ? "#6c766f" : "#15211b",
    });
  }
  return out;
}
    ...
    exams: [
      {
        ...
        rank: 5,
        remark:
          "A steady start to the year. A little more care with presentation in Maths. — Ms. Kapoor",
        subjects: [
          { name: "Mathematics", m: 42, max: 50 },
          { name: "Science", m: 41, max: 50 },
          { name: "English", m: 43, max: 50 },
          { name: "Social Studies", m: 42, max: 50 },
        ],
      },
      {
        id: "hy",
        ...
        rank: 4,
        remark:
          "Good all-round performance. Reading comprehension has clearly improved. — Ms. Kapoor",
        subjects: [
          { name: "Mathematics", m: 71, max: 80 },
          { name: "Science", m: 68, max: 80 },
          { name: "English", m: 70, max: 80 },
          { name: "Social Studies", m: 69, max: 80 },
        ],
      },
      {
        id: "ut2",
        ...
        rank: 3,
        remark:
          "Excellent improvement in Maths this term. Keep encouraging daily reading at home. — Ms. Kapoor",
        subjects: [
          { name: "Mathematics", m: 46, max: 50 },
          { name: "Science", m: 44, max: 50 },
          { name: "English", m: 43, max: 50 },
          { name: "Social Studies", m: 43, max: 50 },
        ],
      },
      {
        id: "ut3",
    ...
    exams: [
      {
        ...
        rank: 6,
        remark:
          "Settling in well. More practice needed with multiplication tables. — Mr. Verma",
        subjects: [
          { name: "Mathematics", m: 40, max: 50 },
          { name: "Science", m: 41, max: 50 },
          { name: "English", m: 42, max: 50 },
          { name: "Social Studies", m: 40, max: 50 },
        ],
      },
      {
        id: "hy",
        name: "Half-Yearly",
        rank: 4,
        remark: "Consistent effort across all subjects. — Mr. Verma",
        subjects: [
          { name: "Mathematics", m: 69, max: 80 },
          { name: "Science", m: 66, max: 80 },
          { name: "English", m: 70, max: 80 },
          { name: "Social Studies", m: 67, max: 80 },
        ],
      },
      {
        id: "ut2",
        name: "Unit Test 2",
        rank: 3,
        remark: "A strong showing in English and Maths. — Mr. Verma",
        subjects: [
          { name: "Mathematics", m: 44, max: 50 },
          { name: "Science", m: 42, max: 50 },
          { name: "English", m: 44, max: 50 },
          { name: "Social Studies", m: 43, max: 50 },
        ],
      },
      {
        ...
        rank: 2,
        remark:
          "An excellent year. Promoted to Grade 5 with distinction. — Mr. Verma",
        subjects: [
          { name: "Mathematics", m: 92, max: 100 },
          { name: "Science", m: 88, max: 100 },
          { name: "English", m: 90, max: 100 },
          { name: "Social Studies", m: 86, max: 100 },
        ],
      },
    ],
  },
    ...
    exams: [
      {
        ...
        name: "Half-Yearly",
        rank: 3,
        remark: "Curious and participative in class. — Mrs. Fernandes",
        subjects: [
          { name: "Mathematics", m: 71, max: 80 },
          { name: "EVS", m: 70, max: 80 },
          { name: "English", m: 68, max: 80 },
          { name: "Hindi", m: 70, max: 80 },
        ],
      },
      {
        id: "ann",
        ...
        rank: 2,
        remark:
          "A wonderful year of growth. Promoted to Grade 4. — Mrs. Fernandes",
        subjects: [
          { name: "Mathematics", m: 92, max: 100 },
          { name: "EVS", m: 90, max: 100 },
          { name: "English", m: 88, max: 100 },
          { name: "Hindi", m: 90, max: 100 },
        ],
      },
    ],
  },
...
export const TEACHER_CLASSES: TeacherClass[] = [
  {
    ...
    count: 32,
    subjects: ["math", "sci", "eng", "soc"],
    ct: true,
  },
  {
    id: "5A",
    label: "Grade 5-A",
    roleLabel: "Mathematics",
    count: 30,
    subjects: ["math"],
    ct: false,
  },
...
export const SUBJ_META: Record<string, string> = {
  math: "Mathematics",
  sci: "Science",
  eng: "English",
  soc: "Social Studies",
...
export const CT_NAME_OF: Record<string, string> = {
  "5B": "Ms. Rao",
  "5A": "Ms. Iyer",
  "6A": "Mr. Verma",
};
export const SEEDED_ABS: Record<string, string[]> = {
  "5A": ["5A-3", "5A-7"],
  "6A": ["6A-5"],
};
...
export type ClassDiary = Record<
  string,
  Record<string, { subj: string; note: string }[]>
>;
export const CLASS_DIARY: ClassDiary = {
  "5B": {
    "24": [
      { subj: "Mathematics", note: "Worksheet 11 (part B)" },
      { subj: "Science", note: "Read pp. 36–39" },
      { subj: "EVS", note: "Water cycle diagram" },
    ],
    "25": [
      { subj: "Mathematics", note: "Worksheet 12, fractions" },
      { subj: "Science", note: "Read pp. 40–44, leaf diagram" },
      { subj: "English", note: 'Paragraph on "My favourite season"' },
    ],
  },
...
export const TEACHERS: Teacher[] = [
  ...
  },
  {
    ...
    name: "Harpreet Singh",
    initials: "HS",
    subject: "Phys. Education",
    subjects: ["Phys. Education"],
    phone: "9811199900",
    classes: ["5-A", "5-B", "6-A", "6-B"],
    ct: "",
    status: "invited",
...
export const ADMIN_ACTIVITY = [
  {
    dot: "#1f8a5b",
    title: "Ms. Rao marked 5-B register",
    sub: "30 present · 2 absent",
    tm: "9:12",
  },
  {
    dot: "#c2a04e",
    title: "Unit Test 2 results published",
    sub: "Grade 5-B · Ms. Kapoor",
    tm: "1d",
  },
  {
    dot: "#15412f",
    title: "New notice posted",
    sub: "Half-day this Friday",
    tm: "1d",
  },
];

export function subjectsOf(t: Teacher) {
  return t.subjects && t.subjects.length
    ? t.subjects
    : t.subject
      ? [t.subject]
      : [];
...
export function teachOf(t: Teacher): Record<string, string[]> {
  return (
    t.teach ||
    Object.fromEntries((t.classes || []).map((c) => [c, subjectsOf(t)]))
  );
}
